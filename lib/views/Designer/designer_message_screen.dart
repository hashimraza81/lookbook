...
class DesignerMessageScreen extends StatefulWidget {
  const DesignerMessageScreen({super.key});

  @override
  State<DesignerMessageScreen> createState() => _DesignerMessageScreenState();
}

class _DesignerMessageScreenState extends State<DesignerMessageScreen> {
  @override
